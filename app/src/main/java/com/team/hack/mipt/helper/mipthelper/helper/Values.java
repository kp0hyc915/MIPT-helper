...
public final class Values {
    ...
    public final static String picturePath = "picture_path";
    public final static String keyQuestions = "key_questions";
    ...
    public final static String list_list = "list_list";
    public final static String link_bitmap = "link_bitmap";
    public final static String name_lab = "name_lab";
}